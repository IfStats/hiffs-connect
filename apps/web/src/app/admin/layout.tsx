      ...
      <div className="grid min-h-screen lg:grid-cols-[280px_1fr]">
        <aside className="hidden bg-slate-950 text-white lg:flex lg:flex-col">
          <div className="border-b border-white/10 px-6 py-6">
            ...
            >
              <div className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-cyan-500 shadow-lg shadow-blue-950/40">
                ...
                <span className="absolute -right-1 -top-1 h-3 w-3 rounded-full border-2 border-slate-950 bg-red-400" />
              </div>
          ...
          <div className="flex-1 overflow-y-auto px-4 py-6">
            ...
            <Link
              href="/dashboard"
              className="flex items-center rounded-xl px-4 py-3 text-sm font-medium text-slate-400 transition hover:bg-white/10 hover:text-white"
            >
              ← Customer workspace
            </Link>
          </div>
          ...
          <div className="border-t border-white/10 p-4">
            <div className="rounded-2xl bg-white/[0.06] p-4">
              ...
              <div className="mt-3 inline-flex rounded-full bg-red-500/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider text-red-300">
                Super Admin
              </div>
            </div>
